...
const contact_detail = [
  ...
  },
  {
    title: "Email",
    icon: <RiMailLine/>,
    info:"krishnaveniadla98@gmail.com"
  },
]
  ...
  return (
    <footer className='footer'>
      ...
      <div className='footer__copyright'>
              <p className="copyright">Copyright {year}, design and develop by Krishnaveni Adla. All rights reserved</p>
      </div>  
    </footer>
  )
}
